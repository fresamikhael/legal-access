    ...
    <form action="">
      <div class="container">
          ...
          <div class="col-lg-6">
            <div class="mb-3 row">
              ...
              <label class="col-sm-5 col-form-label my-2"
                >Jenis Costumer</label
              >
              <div class="col-sm-7 my-2">
                <input type="text" class="form-control" />
              </div>
              <label class="col-sm-5 col-form-label my-2">Asuransi Barang</label>
              <div class="col-sm-7 my-2">
                <input type="text" class="form-control" />
              </div>
              <label class="col-sm-5 col-form-label my-2"
        ...
        <div class="d-flex justify-content-start">
          ...
          <div class="col-lg-6">
            <div class="mb-3 row">
              <label class="col-sm-4 col-form-label my-2">MOM/Penawaran Kesepakatan Para Pihak</label>
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              <label class="col-sm-4 col-form-label my-2">
                Draft Perjanjian dalam bentuk word</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
