    ...
    <form action="">
      <div class="container">
        ...
        <div class="d-flex justify-content-between">
          ...
          <div class="col-lg-6">
            <div class="mb-3 row">
              ...
              <label class="col-sm-5 col-form-label my-2">Nominal Deposit</label>
              <div class="col-sm-7 my-2">
                <input type="text" class="form-control" />
              </div>
        ...
        <div class="d-flex justify-content-start mt-2">
          <div class="col-lg-12">
            <div class="mb-3 row">
              <label class="col-sm-2 col-form-label my-2">Tipe Landlord</label>
              <div class="col-sm-5">
        ...
        <div class="d-flex justify-content-start">
          ...
          <div class="col-lg-6">
            <div class="mb-3 row">
              <label class="col-sm-4 col-form-label my-2">Disposisi Persetujuan Direksi</label>
              <div class="col-sm-7">
              ...
              <label class="col-sm-4 col-form-label my-2">
                Kartu Identitas Pemilik Hak *</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              <label class="col-sm-4 col-form-label my-2">
                Nomor Pokok Wajib Pajak Pemilik *</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              ...
              <label class="col-sm-4 col-form-label my-2"
                >Akta Pendirian dan Perubahan Terakhir **</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              ...
              <label class="col-sm-4 col-form-label my-2"
                >Nomor Pokok Wajib Pajak Perusahaan (NPWP) **</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              ...
              <label class="col-sm-4 col-form-label my-2"
                >Sertipikat / Girik</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              <label class="col-sm-4 col-form-label my-2"
                >Izin Mendirikan Bangunan</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
            ...
            <div class="col-sm-7">
             ...
             <label class="col-sm-4 col-form-label my-2"
              ...
              <label class="col-sm-4 col-form-label my-2"
                >Asli Surat Kuasa</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              <label class="col-sm-4 col-form-label my-2"
                >Perjanjian Sewa Sebelumnya</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              <label class="col-sm-4 col-form-label my-2"
                >Surat Kuasa Direksi</label
              >
              <div class="col-sm-7">
                <input type="file" class="form-control my-2" />
              </div>
              <span class="col-lg-12 mt-5">* Jika Pemilik Perorangan</span>
              <span class="col-lg-12">** Jika Pemilik Badan Hukum dan Badan Usaha</span>
            </div>
          </div>
        </div>
