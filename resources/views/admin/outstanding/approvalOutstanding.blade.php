  ...
  <body>
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="row">
            ...
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="nama_perusahaan" value="{{ $data->nama_perusahaan }}" readonly />
            </div>
            <label class="col-sm-6 col-form-label my-2"
            >Unit/Departemen/Divisi</label
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="unit" value="{{ $data->unit }}" readonly />
            </div>
        </div>
        <div class="row">
            <label class="col-sm-6 col-form-label my-2"
            ...
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="no_perjanjian" value="{{ $data->no_perjanjian }}" readonly />
            </div>
            <label class="col-sm-6 col-form-label my-2"
            >Total Kerugian</label
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="total_outstanding" value="{{ $data->total_outstanding }}" readonly />
            </div>
            <label class="col-sm-6 col-form-label my-2"
            >Dari Tanggal</label
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="dari_tanggal" value="{{ $data->dari_tanggal }}" readonly />
            </div>
            <label class="col-sm-6 col-form-label my-2"
            >Sampai Tanggal</label
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="sampai_tanggal" value="{{ $data->sampai_tanggal }}" readonly />
            </div>
        </div>
        </div>
        <div class="ms-3 col-lg-6">
            <div class="row">
                ...
                <div class="col-sm-12 my-2">
                    <select name="status_nama_perusahaan" id="" class="form-control">
                        <option value="APPROVE">APPROVE</option>
                        <option value="REJECT">REJECT</option>
                    </select>                </div>
                <div class="col-sm-12 my-2">
                ...
                <div class="col-sm-12 my-2">
                    <select name="status_no_perjanjian" id="" class="form-control">
                        <option value="APPROVE">APPROVE</option>
                        <option value="REJECT">REJECT</option>
                    </select>                </div>
                <div class="col-sm-12 my-2">
                    <select name="status_dari_tanggal" id="" class="form-control">
                        <option value="APPROVE">APPROVE</option>
                        <option value="REJECT">REJECT</option>
                    </select>                </div>
                <div class="col-sm-12 my-2">
                    <select name="status_sampai_tanggal" id="" class="form-control">
                        <option value="APPROVE">APPROVE</option>
                        <option value="REJECT">REJECT</option>
                    </select>                </div>
            </div>
    ...
    <div class="d-flex justify-content-start mt-4">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-6">
                <input type="file" class="form-control my-2" name="rekap_data" value="{{ $data->rekap_data }}" readonly />
            </div>
            ...
            <div class="col-sm-6">
            <input type="file" class="form-control my-2" name="bukti_dokumen" value="{{ $data->bukti_dokumen }}" readonly />
            </div>
            <div class="col-sm-1 my-2">
                <button class="btn btn-secondary"><i class="fas fa-download"></i></button>
            </div>
            ...
            <div class="col-sm-6">
            <input type="file" class="form-control my-2" name="perjanjian" value="{{ $data->perjanjian }}" readonly />
            </div>
            <div class="col-sm-1 my-2">
                <button class="btn btn-secondary"><i class="fas fa-download"></i></button>
            </div>
            ...
            >
            <div class="col-sm-6">
            <input type="file" class="form-control my-2" name="bukti_penagihan" value="{{ $data->bukti_penagihan }}" readonly />
            </div>
            <div class="col-sm-1 my-2">
                <button class="btn btn-secondary"><i class="fas fa-download"></i></button>
            </div>
        ...
        <div class="mb-3 row">
            <div class="col-sm-4 my-2">
                <select name="status_rekap_data" id="" class="form-control">
                    <option value="APPROVE">APPROVE</option>
                    <option value="REJECT">REJECT</option>
                </select>
            </div>
            <div class="col-sm-6 my-2">
                <input type="text" class="form-control" name="alasan_rekap_data" placeholder="Reason if Rejected"/>
            </div>
            <div class="col-sm-4 my-2">
                <select name="status_bukti_dokumen" id="" class="form-control">
                    <option value="APPROVE">APPROVE</option>
                    <option value="REJECT">REJECT</option>
                </select>
            </div>
            <div class="col-sm-6 my-2">
                <input type="text" class="form-control" name="alasan_bukti_dokumen" placeholder="Reason if Rejected"/>
            </div>
            <div class="col-sm-4 my-2">
                <select name="status_perjanjian" id="" class="form-control">
                    <option value="APPROVE">APPROVE</option>
                    <option value="REJECT">REJECT</option>
                </select>
            </div>
            <div class="col-sm-6 my-2">
                <input type="text" class="form-control" name="alasan_perjanjian" placeholder="Reason if Rejected"/>
            </div>
            <div class="col-sm-4 my-2">
                <select name="status_bukti_penagihan" id="" class="form-control">
                    <option value="APPROVE">APPROVE</option>
                    <option value="REJECT">REJECT</option>
                </select>
            </div>
            <div class="col-sm-6 my-2">
                <input type="text" class="form-control" name="alasan_bukti_penagihan" placeholder="Reason if Rejected"/>
            </div>
        </div>
        </div>
    </div>
        <div class="d-flex justify-content-start">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                    <input type="file" class="form-control my-2" name="disposisi" value="{{ $data->disposisi }}" readonly />
                </div>
                <div class="col-sm-1 my-2">
                    <button class="btn btn-secondary"><i class="fas fa-download"></i></button>
                </div>
                ...
                >
                <div class="col-sm-6">
                    <input type="file" class="form-control my-2" name="dokumen_lainnya" value="{{ $data->dokumen_lainnya }}" readonly />
                </div>
                <div class="col-sm-1 my-2">
                <button class="btn btn-secondary"><i class="fas fa-download"></i></button>
            </div>
