  ...
  <body>
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="row">
            ...
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="nama_pihak" value="{{ $data->nama_pihak }}" readonly />
            </div>
            <label class="col-sm-6 col-form-label my-2"
        ...
        <div class="row">
            ...
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="nilai_kerugian" value="{{ $data->nilai_kerugian }}" readonly />
            </div>
            <label class="col-sm-6 col-form-label my-2"
            >Nomor Dokumen</label
            >
            <div class="col-sm-6 my-2">
            <input type="text" class="form-control" name="no_dokumen" value="{{ $data->no_dokumen }}" readonly />
            </div>
        </div>
        </div>
